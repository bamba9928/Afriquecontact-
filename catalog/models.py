...
class Location(models.Model):
    ...
    class Meta:
        ...
        indexes = [models.Index(fields=["type"]), models.Index(fields=["slug"])]
...
class JobCategory(models.Model):
    name = models.CharField(max_length=120)
    slug = models.SlugField(max_length=160, unique=True)
    # Champ parent pour transformer la catégorie en sous-catégorie
    parent = models.ForeignKey(
        "self",
        null=True,
        blank=True,
...
class Job(models.Model):
    name = models.CharField(max_length=120)
    slug = models.SlugField(max_length=160, unique=True)
    # On lie maintenant le métier à la catégorie (qui peut être une sous-catégorie)
